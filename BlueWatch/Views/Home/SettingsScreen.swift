                ...
                Section {
                    VStack(spacing: 16) {
                        ...
                        if settings.pushLocation {
                            Divider()
                            Stepper(
                                "Location Rate Limit: \(settings.locationRateLimit) min",
                                value: $settings.locationRateLimit,
                                in: 0...60,
                                step: 5
                            )
                ...
                Section {
                    VStack(spacing: 16) {
                        ...
                        .alert("Are you sure?", isPresented: $showDeletePrompt)
                        {
                            ...
                            Text(
                                "This action permanently deletes the metrics shown in graphs from your device. Data saved to Health will not be deleted."
                            )
                        }
                        .tint(.primary)
                    }
